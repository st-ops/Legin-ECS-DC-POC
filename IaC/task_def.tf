...
resource "aws_ecs_task_definition" "fullstack" {
  ...
  container_definitions = jsonencode([
    {
        "name": "frontend",
        "image": "docker.io/legin04/fullstack-frontend:latest",
        "cpu": 0,
        "portMappings": [
            {
        ...
        "logConfiguration": {
            ...
            "options": {
                ...
                "awslogs-group": "/ecs/dev-fullstack-td",
    ...
    {
        "name": "backend",
        "image": "docker.io/legin04/fullstack-backend:latest",
        "cpu": 0,
        "portMappings": [],
        "essential": true,
        "environment": [
    ...
    {
        "name": "mysql",
        "image": "docker.io/legin04/fullstack-mysql:latest",
        "cpu": 0,
        "portMappings": [],
        "essential": true,
        "environment": [
